...
@section('title', 'Edit Data Diri | Peserta')

@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary">Edit Data Diri Peserta</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('datadiri.update', $peserta->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sekolah" class="form-control" id="sekolah"
                        value="{{ old('sekolah', $peserta->sekolah) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="alamat" class="form-control" id="alamat" required>{{ old('alamat', $peserta->alamat) }}</textarea>
                </div>
                ...
                <a href="{{ route('peserta.datadiri.index') }}" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
@endsection
