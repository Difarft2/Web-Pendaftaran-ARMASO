...
@section('title', 'Buat Data Peserta | Admin')

@section('content')
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary">Buat Data Diri Peserta Offline</h5>
        <div class="d-flex justify-content-end mb-3">
        </div>
    </div>
    <div class="card-body">
        <form action="{{ route('ofline.store') }}" method="POST">
            @csrf
