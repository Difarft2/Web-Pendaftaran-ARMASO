...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-primary">Edit Data Diri Peserta Offline</h5>
        <div class="d-flex justify-content-end mb-3">
        </div>
    </div>
    <div class="card-body">
        <form action="{{ route('ofline.update', $peserta->id) }}" method="POST">
            @csrf
            ...
            <a href="{{ route('ofline.show', $peserta->id) }}" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</div>
@endsection